 ...
 */
public class HelloOpenXRGLOrig {
    ...
    public static void main(String[] args) throws InterruptedException {
        HelloOpenXRGLOrig helloOpenXR = new HelloOpenXRGLOrig();
    ...
    public void initializeAndBindOpenGL() {
        try (MemoryStack stack = stackPush()) {
            ...
            Struct graphicsBinding = XRHelper.createGraphicsBindingOpenGLOrig(stack, window);
